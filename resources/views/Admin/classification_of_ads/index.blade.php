...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('classification_of_ads.index')}}', columns);
        // Delete Using Ajax
        deleteScript('{{route('classification_of_ads.delete')}}');
        // Add Using Ajax
        showAddModal('{{route('classification_of_ads.create')}}');
        addScript();
        // Edit Using Ajax
        showEditModal('{{route('classification_of_ads.edit',':id')}}');
        editScript();
    </script>
@endsection
