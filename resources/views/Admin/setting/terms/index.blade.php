        ...
        <div class="col-md-12 col-lg-12">
            <div class="modal-body">
                <form id="updateForm" method="POST" enctype="multipart/form-data" action="{{route('update_terms',$terms->id)}}" >
                    ...
                    <div class="form-group">
                        <label for="name" class="form-control-label">الشروط و الاحكام بالكردية</label>
                        <textarea name="terms_ku" class="form-control editor" id="terms_en">{{$terms->terms_ku}}</textarea>
                    </div>
