        ...
        <div class="col-md-12 col-lg-12">
            <div class="modal-body">
                <form id="updateForm" method="POST" enctype="multipart/form-data" action="{{route('update_privacy',$privacy->id)}}" >
                    ...
                    <div class="form-group">
                        <label for="name" class="form-control-label">الخصوصية بالكردية</label>
                        <textarea name="privacy_ku" class="form-control editor" id="privacy_en">{{$privacy->privacy_ku}}</textarea>
                    </div>
