            ...
            <div class="modal-body">
                <form id="updateForm" method="POST" enctype="multipart/form-data" action="{{route('update_about',$abouts->id)}}" >
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about_us_ar" class="form-control editor" id="about_ar">{{$abouts->about_us_ar}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="name" class="form-control-label">من نحن بالانجليزية</label>
                        <textarea name="about_us_en" class="form-control editor" id="about_ar">{{$abouts->about_us_en}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="name" class="form-control-label">من نحن بالكردية</label>
                        <textarea name="about_us_ku" class="form-control editor" id="about_ar">{{$abouts->about_us_ku}}</textarea>
                    </div>
