    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="{{asset('assets/admin/images/logo11.jpg')}}" class="header-brand-img mobile-icon" alt="logo">
                <img src="{{asset('assets/admin/images/logo11.jpg')}}" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
...
{{--                        </a>--}}
                        <a class="dropdown-item" href="{{ route('home') }}" target="_blank">
                            <i class="dropdown-icon mdi mdi-monitor"></i>الذهاب للموقع
                        </a>
